#ifndef BEHAVIOR_PLUGINS__SEARCH_LOCAL_GOAL_ASIDE_HPP_
#define BEHAVIOR_PLUGINS__SEARCH_LOCAL_GOAL_ASIDE_HPP_
...
#endif  // BEHAVIOR_PLUGINS__SEARCH_LOCAL_GOAL_ASIDE_HPP_
